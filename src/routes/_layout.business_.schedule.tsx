...
function RouteComponent() {
    ...
    const scheduleColumns = useMemo<ColumnDef<Schedule, any>[]>(() => getScheduleColumns(handleEdit, handleSingleDelete), []);
        ...
        <div>
            ...
            <Tabs defaultValue="table" value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="table">
                    <h2 className="my-2 text-xl font-medium dark:text-gray-300">Jadwal</h2>
