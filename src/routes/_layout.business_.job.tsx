...
export const Route = createFileRoute("/_layout/business_/job")({
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <DropdownMenu>
                ...
                <DropdownMenuContent>
                    <DropdownMenuItem>
                        <Link to="/business/job/$job_id" params={{ job_id: String(row.original.id) }} className="w-full">
                            Detail
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem>
                        <Link to="/business/job/edit/$job_id" params={{ job_id: String(row.original.id) }} className="w-full">
                            Edit
                        </Link>
                    </DropdownMenuItem>
