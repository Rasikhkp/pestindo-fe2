...
export const Route = createFileRoute("/_layout/sales_/supplier_/create")({
...
function RouteComponent() {
    ...
    const createSupplierMutation = useMutation({
        mutationFn: (data: SupplierFormType) => api().post("suppliers", { json: data }).json(),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["suppliers"] });

            navigate({ from: "/sales/supplier/create", to: "/sales/supplier" });
        },
    ...
    return (
        <>
            ...
            <div className="my-2 text-xl font-medium dark:text-gray-300">Tambah Supplier</div>
            <div className="mt-2 mb-4 text-sm text-gray-700 dark:text-gray-400">Tambah Daftar Supplier Baru</div>
