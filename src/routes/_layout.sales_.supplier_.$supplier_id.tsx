...
export const Route = createFileRoute("/_layout/sales_/supplier_/$supplier_id")({
...
function RouteComponent() {
    ...
    return (
        <>
            ...
            <div className="my-2 text-xl font-medium dark:text-gray-300">Kode Supplier #{supplier.code}</div>
            <div className="mt-2 mb-8 text-sm text-gray-700 dark:text-gray-400">Detail Informasi Supplier</div>
            ...
            <div className="flex flex-col gap-4 mb-4 xl:flex-row">
                ...
                <motion.div transition={{ duration: 0.8, ease: "easeInOut" }} className="flex flex-wrap gap-4 h-fit">
                    ...
                    >
                        ...
                        <div className="text-4xl font-bold">{formatToRupiah(supplier.total_order_price || 0)}</div>
                    ...
                    >
                        ...
                        <div className="text-4xl font-bold">{supplier.total_orders || 0}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Total Order</div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="text-4xl font-bold">{supplier.total_completed_orders || 0}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Order Selesai</div>
                    </motion.div>
                </motion.div>
            </div>
    ...
    return (
        <div className=" bg-white border border-gray-200 rounded-xl dark:bg-[#30334E] dark:border-gray-600">
            <div className="flex flex-col justify-between gap-2 p-4 border-b border-gray-200 sm:items-center sm:flex-row dark:border-gray-600">
                <div className="text-lg font-medium text-gray-600 dark:text-gray-200">Daftar Order</div>
                <div className="flex gap-2">
                    ...
                    <div className="flex gap-2">
                        <Select
                            ...
                            onValueChange={(val) => table.getHeaderGroups()[0].headers[4].column.setFilterValue(val)}
                        >
