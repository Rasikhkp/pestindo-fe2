...
const fetchLogs = async ({
  ...
  const response: LogsApiResponse = await api()
    .get('inventory-logs', { searchParams })
    .json()
  return response
}

export const Route = createFileRoute('/_layout/technician_/log')({
          ...
          <div className="w-full md:w-auto">
            ...
            >
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full md:w-auto min-w-[200px] justify-start gap-2"
                >
            ...
            {allLogs.map((log) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getChangeReasonBadgeClass(log.change_reason)}`}
                    >
